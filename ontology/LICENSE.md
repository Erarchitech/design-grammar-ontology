# Licence — ontology and specifications

The contents of `ontology/` and `spec/` in this repository are licensed under the
...
under the Apache License 2.0; see `LICENSE` at the repository root.
